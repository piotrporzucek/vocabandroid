...
import pl.egalit.vocab.client.MyRequestFactory.RegistrationInfoRequest;
...
public class DeviceRegistrar {
	...
	public static void registerOrUnregister(final Context context,
		...
		final String accountName = settings.getString(Util.ACCOUNT_NAME,
				"Unknown");
		...
		Request<Void> req;
		if (register) {
			req = request.register(proxy);
		} else {
			req = request.unregister(proxy);
		}
